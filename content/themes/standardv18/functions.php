<?php 
	...
	function sj_enqueue_scripts(){
		...
		# register
		wp_register_script('slick',get_bloginfo('template_directory').'/prod/slick.min.js',array('jquery'),true);
		wp_register_script( 'mustache', '//cdnjs.cloudflare.com/ajax/libs/mustache.js/0.8.1/mustache.min.js', false, '0.8.1', true );
		wp_register_script('site',get_bloginfo('template_directory').'/prod/scripts.js',false,true);
